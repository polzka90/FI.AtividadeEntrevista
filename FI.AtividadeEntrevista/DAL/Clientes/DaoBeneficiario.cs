...
namespace FI.AtividadeEntrevista.DAL.Clientes
{
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        /// </summary>
        /// <param id="cliente">Objeto de beneficiario</param>
        ...
        private List<DML.Beneficiario> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    DML.Beneficiario Bef = new DML.Beneficiario();
                    Bef.Id = row.Field<long>("Id");
                    Bef.CPF = row.Field<string>("CPF");
                    Bef.Nome = row.Field<string>("Nome");
                    Bef.IdCliente = row.Field<long>("IDCLIENTE");
